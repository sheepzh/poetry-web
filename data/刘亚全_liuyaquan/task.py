...
def index_to_title(_title, index): return str(index + 6)


# split_by_regrex('短诗', r'^（.）$', prefix='短诗', date='201007', title_map=index_to_title)

split_by_regrex('短诗', r'^（(.)）$', prefix='短诗', date='201007')
